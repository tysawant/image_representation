%% Initialization
img1 = im2single(imread('data\images\102061.jpg'));
imshow(img1);
sd = 7;
%theta = size(img(:,:,1));
...
g_der_90 = imfilter(g,[1 0 -1; 1 0 -1; 1 0 -1]);
g_der_180 = imfilter(g,[1 0 -1; 1 0 -1; 1 0 -1]);
g_der_270 = imfilter(g,[1 0 -1; 1 0 -1; 1 0 -1]);
